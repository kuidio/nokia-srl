...
func doGen() error {
	...
	if gen["openapi-gen"] {
		err := run(getCmd("openapi-gen",
			"--input-dirs", "k8s.io/apimachinery/pkg/api/resource,"+
				...
				"github.com/kuidio/kuid/apis/condition/v1alpha1,"+
				inputs,
	...
	if gen["go-to-protobuf"] {
		err := run(getCmd("go-to-protobuf",
			"--packages", inputs,
			"--apimachinery-packages", "-k8s.io/apimachinery/pkg/api/resource,-k8s.io/apimachinery/pkg/runtime/schema,-k8s.io/apimachinery/pkg/runtime,-k8s.io/apimachinery/pkg/apis/meta/v1,-k8s.io/api/core/v1,-github.com/kuidio/kuid/apis/condition/v1alpha1",
			"--proto-import", "./vendor",
		))
		if err != nil {
			return err
